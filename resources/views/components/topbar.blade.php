<div class="lg:hidden fixed top-0 left-0 right-0 h-11 bg-base-100 shadow-sm shadow-gray-300 dark:shadow-gray-300 rounded-b-2xl py-7 flex items-center px-3 z-50">
